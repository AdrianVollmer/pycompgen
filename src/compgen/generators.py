...
def generate_completions(packages: List[CompletionPackage]) -> List[GeneratedCompletion]:
...
def generate_click_completion(package: CompletionPackage) -> Optional[GeneratedCompletion]:
...
def generate_argcomplete_completion(package: CompletionPackage) -> Optional[GeneratedCompletion]:
